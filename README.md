...
| WeChat DevTools | Official IDE for developing WeChat Mini Programs and Official Accounts. | [developers.weixin.qq.com](https://developers.weixin.qq.com/miniprogram/dev/devtools/download.html) | Manual install |
...
| Software | Introduction | Official site | Install command |
|---|---|---|---|
| Docker Desktop | Container platform for building and running Linux containers on Windows. | [docker.com](https://www.docker.com/) | Manual install |
...
| ContextMenuManager | Portable manager for Windows right-click context menu entries. | [github.com/BluePointLilac](https://github.com/BluePointLilac/ContextMenuManager) | Manual install |
...
| Bandizip | Fast archiver supporting ZIP, 7Z, RAR and more. | [bandisoft.com](https://www.bandisoft.com/bandizip/) | `scoop install bandizip`  (extras) |
...
| PixPin | Screenshot, pin-to-screen, long-capture, OCR and screen-recording tool. | [pixpin.com](https://pixpin.com/) | Manual install |
...
| Software | Introduction | Official site | Install command |
|---|---|---|---|
| AnyTXT Searcher | Desktop full-text search engine for local documents. | [anytxt.net](https://anytxt.net/) | Manual install |
| PDF24 Creator | Free offline toolkit to create, merge, compress and edit PDF files. | [pdf24.org](https://www.pdf24.org/en/) | Manual install |
...
| Software | Introduction | Official site | Install command |
|---|---|---|---|
| Baidu Netdisk | Cloud storage client from Baidu. | [pan.baidu.com](https://pan.baidu.com/) | Manual install |
| Quark Cloud Drive | Cloud storage desktop client from Quark. | [pan.quark.cn](https://pan.quark.cn/) | Manual install |
...
| NetEase Cloud Music | Music streaming client with personalised recommendations and social features. | [music.163.com](https://music.163.com/) | Manual install |
...
| WeLink | Huawei Cloud enterprise collaboration and video conferencing client. | [huaweicloud.com](https://www.huaweicloud.com/product/welink.html) | Manual install |

## Science and Personal Data

| Software | Introduction | Official site | Install command |
|---|---|---|---|
| QGIS | Open-source geographic information system for viewing and analysing spatial data. | [qgis.org](https://qgis.org/) | Manual install |
...
Entries are grouped by what a program does, following the taxonomy that community software lists use. The install command column states how each entry is best installed: `scoop install` (with the bucket in brackets when it is not `main`), `npm install -g`, or "Manual install" when the program has to come from its official page. The batch commands at the top of Runtimes and Package Managers install every Scoop-managed entry at once.

Scoop manifest names were matched against the `main`, `extras` and `java` buckets. Entries without a public homepage are linked to their official repository instead.
